...
//Anotação  utilizada para testar uma interface Repository
@DataJpaTest
//Anotações para usar o banco de dados real da aplicação, retira o que vem automaticamente que é o "in memory" (na memória)
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("Paulo", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("João", "paciente@email.com", "000.000.000-00");
